...
//@Autonomous(name = "(IMUdriveOld)", group = "Sensor")
...
//                    Scanned = true;
//                }
                    telemetry.addData("We are here inside", "Inside Opmode active");
                }
                telemetry.addData("We are here outside", "outside Opmode active");
                telemetry.update();
                ...
                telemetry.addData("Linear Move Pre", "Pre Limear Move");
                linearMove(10,0.55,false);
                telemetry.addData("Linear Move Post", "Post Limear Move");

                move(0.2,0.25,false,false);
                strafe(0.2,0.25,false,false);
                sleep(2000);
                linearMove(15,0.25,false);
                claw.setPosition(1);
                sleep(250);
                strafe(3.6, 0.25, true, false);
                linearMove(25,0.25,true);
                if (scan == "1") {
                    // move(2.2, 0.25, false);
                ...
                telemetry.addData("I am in the else", "I am in the else");
                claw.setPosition(1);
