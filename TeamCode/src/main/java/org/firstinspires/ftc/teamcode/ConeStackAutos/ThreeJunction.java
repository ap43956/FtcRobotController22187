...
@Autonomous(name = "ThreeJunction", group = "Sensor")
public class ThreeJunction extends LinearOpMode {
...
//                }
                ...
                moveRobot.move(myHardware, 6, 0.5, false, true);
                sleep(20);
                ...
                moveRobot.strafe(myHardware, 8.5, 0.5, true, true);
                myHardware.getClaw().setPosition(1);
                //Moves over and parks
                moveRobot.strafe(myHardware, 14.5, 0.5, true, true);
                if (scan == "1") {
                    telemetry.addLine("VUFORIA 1");
                    moveRobot.move(myHardware, 44, 0.5, false, true);
                } else if (scan == "2") {
                    telemetry.addLine("VUFORIA 2");
                    moveRobot.move(myHardware, 23, 0.5, false, true);
                } else if (scan == "3") {
